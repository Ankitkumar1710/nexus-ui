    ...
    <>
      ...
      >
        <div className="container mx-auto px-4">
              ...
              return (
                ...
                >
                  ...
                  <div className="pt-10 p-6">
                    <h3 className="text-lg font-bold mb-2 text-gray-900 dark:text-white group-hover:text-brand transition">
                      {item.title}
                    </h3>
          ...
          {/* CTA */}
          <div className="mt-16 bg-brand rounded-xl p-8 md:p-12 text-white max-w-4xl mx-auto shadow-lg text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <button
                ...
                className="px-8 py-4 bg-white text-brand font-semibold rounded-xl hover:shadow-lg transition w-full sm:w-auto"
              >
                Call +91 7070637489
              </button>
              ...
              <button
                ...
                className="px-8 py-4 border-2 border-white text-white font-semibold rounded-xl hover:bg-white hover:text-brand transition w-full sm:w-auto"
              >
                Become Partner
              </button>
